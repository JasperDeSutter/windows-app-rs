...
#[doc(hidden)]
pub struct IXamlControlsXamlMetaDataProvider(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IXamlControlsXamlMetaDataProviderStatics(::windows::runtime::IInspectable);
...
pub struct XamlControlsXamlMetaDataProvider(::windows::runtime::IInspectable);
#[cfg(feature = "UI_Xaml_Markup")]
impl XamlControlsXamlMetaDataProvider {
    ...
    #[cfg(all(feature = "UI_Xaml_Markup", feature = "_Xaml_Interop"))]
    pub fn GetXamlType<
        'a,
    ...
    for XamlControlsXamlMetaDataProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Markup::IXamlMetadataProvider> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::Markup::IXamlMetadataProvider>::into(self),
        )
    }
}
#[cfg(feature = "UI_Xaml_Markup")]
    ...
    for &XamlControlsXamlMetaDataProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Markup::IXamlMetadataProvider> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::Markup::IXamlMetadataProvider>::into(
