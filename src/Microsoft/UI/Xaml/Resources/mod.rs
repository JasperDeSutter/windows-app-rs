...
impl CustomXamlResourceLoader {
    ...
    >(
        ...
        let this =
            &::windows::runtime::Interface::cast::<ICustomXamlResourceLoaderOverrides>(self)?;
        unsafe {
    ...
    pub fn SetCurrent<'a, Param0: ::windows::runtime::IntoParam<'a, CustomXamlResourceLoader>>(
        value: Param0,
    ...
    pub fn ICustomXamlResourceLoaderStatics<
        R,
        F: FnOnce(&ICustomXamlResourceLoaderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn ICustomXamlResourceLoaderFactory<
        R,
        F: FnOnce(&ICustomXamlResourceLoaderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for CustomXamlResourceLoader {
    const SIGNATURE : :: windows :: runtime :: ConstBuffer = :: windows :: runtime :: ConstBuffer :: from_slice ( b"rc(Microsoft.UI.Xaml.Resources.CustomXamlResourceLoader;{2832c2e5-2ace-5993-a173-3c9c3b992b2e})" ) ;
}
...
pub struct ICustomXamlResourceLoaderOverrides_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        objecttype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        propertyname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        propertytype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
