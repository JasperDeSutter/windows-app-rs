...
pub struct AnimatedAcceptVisualSource(::windows::runtime::IInspectable);
impl AnimatedAcceptVisualSource {
    ...
    pub fn Markers(
        ...
        super::super::super::super::super::Windows::Foundation::Collections::IMapView<
    ...
    > {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .6 ) ( :: std :: mem :: transmute_copy ( this ) , & mut result__ ) . from_abi :: < super::super::super::super::super::Windows::Foundation::Collections:: IMapView :: < :: windows :: runtime :: HSTRING , f64 > > ( result__ )
        }
    }
    #[cfg(feature = "")]
    pub fn SetColorProperty<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::super::Windows::UI::Color>,
    >(
        &self,
        propertyname: Param0,
        value: Param1,
    ...
    for AnimatedAcceptVisualSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::IAnimatedVisualSource> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::IAnimatedVisualSource>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, super::IAnimatedVisualSource>
    for &AnimatedAcceptVisualSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::IAnimatedVisualSource> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::IAnimatedVisualSource>::into(::std::clone::Clone::clone(
                self,
            )),
        )
    }
...
pub struct AnimatedBackVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedChevronDownSmallVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedChevronRightDownSmallVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedChevronUpDownSmallVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedFindVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedGlobalNavigationButtonVisualSource(::windows::runtime::IInspectable);
...
pub struct AnimatedSettingsVisualSource(::windows::runtime::IInspectable);
