...
impl AutomationProperties {
    ...
    >(
        ...
        super::super::super::super::Windows::Foundation::Collections::IVector<super::UIElement>,
    > {
        Self::IAutomationPropertiesStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .40 ) ( :: std :: mem :: transmute_copy ( this ) , element . into_param ( ) . abi ( ) , & mut result__ ) . from_abi :: < super::super::super::super::Windows::Foundation::Collections:: IVector :: < super:: UIElement > > ( result__ )
        })
    }
    ...
    >(
        ...
        super::super::super::super::Windows::Foundation::Collections::IVector<AutomationAnnotation>,
    > {
        Self::IAutomationPropertiesStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
