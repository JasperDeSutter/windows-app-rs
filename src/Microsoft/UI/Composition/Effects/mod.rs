...
pub struct ISceneLightingEffect_abi(
    ...
    #[cfg(feature = "aphics_Effects")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "aphics_Effects"))] usize,
    #[cfg(feature = "aphics_Effects")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl SceneLightingEffect {
    ...
    pub fn NormalMapSource(
        ...
        super::super::super::super::Windows::Graphics::Effects::IGraphicsEffectSource,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .10 ) ( :: std :: mem :: transmute_copy ( this ) , & mut result__ ) . from_abi :: < super::super::super::super::Windows::Graphics::Effects:: IGraphicsEffectSource > ( result__ )
        }
    }
    #[cfg(feature = "aphics_Effects")]
    ...
    pub fn Name(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::super::Windows::Graphics::Effects::IGraphicsEffect,
        >(self)?;
        unsafe {
...
impl ::std::convert::TryFrom<SceneLightingEffect>
    for super::super::super::super::Windows::Graphics::Effects::IGraphicsEffect
{
...
#[cfg(feature = "aphics_Effects")]
impl ::std::convert::TryFrom<SceneLightingEffect>
    for super::super::super::super::Windows::Graphics::Effects::IGraphicsEffectSource
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: SceneLightingEffect) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
