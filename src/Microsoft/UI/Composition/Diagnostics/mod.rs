...
unsafe impl ::windows::runtime::RuntimeType for CompositionDebugHeatMaps {
    const SIGNATURE : :: windows :: runtime :: ConstBuffer = :: windows :: runtime :: ConstBuffer :: from_slice ( b"rc(Microsoft.UI.Composition.Diagnostics.CompositionDebugHeatMaps;{815016b8-f645-5c55-87b5-fe2167282b6f})" ) ;
}
...
unsafe impl ::windows::runtime::RuntimeType for CompositionDebugSettings {
    const SIGNATURE : :: windows :: runtime :: ConstBuffer = :: windows :: runtime :: ConstBuffer :: from_slice ( b"rc(Microsoft.UI.Composition.Diagnostics.CompositionDebugSettings;{f4c0c0f6-7f5f-5014-a0d6-c8c7eeecace6})" ) ;
}
unsafe impl ::windows::runtime::Interface for CompositionDebugSettings {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32607,
        20500,
        [160, 214, 200, 199, 238, 236, 172, 230],
    );
}
