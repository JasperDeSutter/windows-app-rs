...
#[doc(hidden)]
pub struct IPushNotificationActivationInfo(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPushNotificationActivationInfoFactory(::windows::runtime::IInspectable);
...
pub struct IPushNotificationChannel_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Windows::Foundation::DateTime,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "undation"))] usize,
...
#[doc(hidden)]
pub struct IPushNotificationChannelFactory(::windows::runtime::IInspectable);
...
pub struct IPushNotificationChannelFactory_abi(
    ...
    #[cfg(feature = "tworking_PushNotifications")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        channel: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "tworking_PushNotifications"))] usize,
);
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
#[doc(hidden)]
pub struct IPushNotificationCreateChannelResult(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPushNotificationCreateChannelResultFactory(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPushNotificationManagerStatics(::windows::runtime::IInspectable);
...
pub struct IPushNotificationReceivedEventArgs_abi(
    ...
    #[cfg(not(feature = "plicationModel_Background"))] usize,
    #[cfg(all(feature = "plicationModel_Background", feature = "undation"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        handler: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Windows::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "plicationModel_Background", feature = "undation")))] usize,
    #[cfg(feature = "undation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        token: super::super::super::Windows::Foundation::EventRegistrationToken,
...
pub struct PushNotificationActivationInfo(::windows::runtime::IInspectable);
impl PushNotificationActivationInfo {
    ...
    pub fn GetConditions(
        ...
        ::windows::runtime::Array<
            super::super::super::Windows::ApplicationModel::Background::IBackgroundCondition,
        >,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::Array<
                super::super::super::Windows::ApplicationModel::Background::IBackgroundCondition,
            > = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .8 ) ( :: std :: mem :: transmute_copy ( this ) , :: windows :: runtime :: Array :: < super::super::super::Windows::ApplicationModel::Background:: IBackgroundCondition > :: set_abi_len ( & mut result__ ) , & mut result__ as * mut _ as _ ) . and_then ( || result__ )
        }
    }
    #[cfg(feature = "plicationModel_Background")]
    pub fn SetConditions(
        &self,
        conditions : & [ < super::super::super::Windows::ApplicationModel::Background:: IBackgroundCondition as :: windows :: runtime :: Abi > :: DefaultType ],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
...
pub struct PushNotificationChannel(::windows::runtime::IInspectable);
impl PushNotificationChannel {
    #[cfg(feature = "undation")]
    pub fn Uri(&self) -> ::windows::runtime::Result<super::super::super::Windows::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Windows::Foundation::Uri>(result__)
        }
    }
    #[cfg(feature = "undation")]
    pub fn ExpirationTime(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Windows::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__: super::super::super::Windows::Foundation::DateTime =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::Windows::Foundation::DateTime>(result__)
        }
    }
    ...
    pub fn CreateInstance<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Windows::Networking::PushNotifications::PushNotificationChannel,
        >,
    >(
        channel: Param0,
...
pub struct PushNotificationCreateChannelResult(::windows::runtime::IInspectable);
...
impl PushNotificationManager {
    ...
    >(
        ...
        super::super::super::Windows::Foundation::IAsyncOperationWithProgress<
            PushNotificationCreateChannelResult,
    ...
    > {
        Self::IPushNotificationManagerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Windows::Foundation::IAsyncOperationWithProgress<
                PushNotificationCreateChannelResult,
                PushNotificationCreateChannelStatus,
            >>(result__)
        })
...
pub struct PushNotificationReceivedEventArgs(::windows::runtime::IInspectable);
impl PushNotificationReceivedEventArgs {
    ...
    pub fn GetDeferral(
        ...
        super::super::super::Windows::ApplicationModel::Background::BackgroundTaskDeferral,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .7 ) ( :: std :: mem :: transmute_copy ( this ) , & mut result__ ) . from_abi :: < super::super::super::Windows::ApplicationModel::Background:: BackgroundTaskDeferral > ( result__ )
        }
    }
    #[cfg(all(feature = "plicationModel_Background", feature = "undation"))]    pub fn Canceled < 'a , Param0 : :: windows :: runtime :: IntoParam < 'a , super::super::super::Windows::ApplicationModel::Background:: BackgroundTaskCanceledEventHandler > , > ( & self , handler : Param0 , ) -> :: windows :: runtime :: Result < super::super::super::Windows::Foundation:: EventRegistrationToken >{
        let this = self;
        unsafe {
            let mut result__: super::super::super::Windows::Foundation::EventRegistrationToken =
                ::std::mem::zeroed();
