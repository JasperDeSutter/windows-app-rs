...
pub struct IPowerManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::super::Windows::Foundation::TimeSpan,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "undation"))] usize,
    #[cfg(feature = "undation")]
    pub  unsafe extern "system" fn(
...
impl PowerManager {
    ...
    ) -> ::windows::runtime::Result<super::super::super::super::Windows::Foundation::TimeSpan> {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__: super::super::super::super::Windows::Foundation::TimeSpan =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).18)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Windows::Foundation::TimeSpan>(result__)
        })
    }
    #[cfg(feature = "undation")]
    ...
    #[cfg(feature = "undation")]
    pub fn EffectivePowerMode() -> ::windows::runtime::Result<
        super::super::super::super::Windows::Foundation::IAsyncOperation<EffectivePowerMode>,
    > {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ( :: windows :: runtime :: Interface :: vtable ( this ) .29 ) ( :: std :: mem :: transmute_copy ( this ) , & mut result__ ) . from_abi :: < super::super::super::super::Windows::Foundation:: IAsyncOperation :: < EffectivePowerMode > > ( result__ )
        })
    }
    #[cfg(feature = "undation")]
