...
pub struct AddPackageDependencyOptions(::windows::runtime::IInspectable);
...
pub struct CreatePackageDependencyOptions(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IAddPackageDependencyOptions(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct ICreatePackageDependencyOptions(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPackageDependency(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPackageDependencyContext(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPackageDependencyContextFactory(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPackageDependencyRankStatics(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IPackageDependencyStatics(::windows::runtime::IInspectable);
...
pub struct IPackageDependencyStatics_abi(
    ...
    #[cfg(feature = "plicationModel")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packagefamilyname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        minversion: super::super::super::super::Windows::ApplicationModel::PackageVersion,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "plicationModel"))] usize,
    #[cfg(feature = "plicationModel")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packagefamilyname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct PackageDependency(::windows::runtime::IInspectable);
impl PackageDependency {
    ...
    pub fn Create<
        ...
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Windows::ApplicationModel::PackageVersion,
        >,
    >(
...
pub struct PackageDependencyContext(::windows::runtime::IInspectable);
