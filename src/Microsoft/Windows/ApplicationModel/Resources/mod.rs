...
#[doc(hidden)]
pub struct IKnownResourceQualifierNameStatics(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IResourceCandidateFactory(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IResourceManagerFactory(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IResourceNotFoundEventArgs(::windows::runtime::IInspectable);
...
impl ResourceCandidate {
    ...
    pub fn CreateInstance2(
        data: &[<u8 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<ResourceCandidate> {
        Self::IResourceCandidateFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
...
impl ResourceContext {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::super::Windows::Foundation::Collections::IMap<
                ::windows::runtime::HSTRING,
                ::windows::runtime::HSTRING,
            >>(result__)
        }
...
pub struct ResourceNotFoundEventArgs(::windows::runtime::IInspectable);
