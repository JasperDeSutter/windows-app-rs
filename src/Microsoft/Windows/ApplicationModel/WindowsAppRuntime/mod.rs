...
impl DeploymentResult {
    pub fn Status(&self) -> ::windows::runtime::Result<DeploymentStatus> {
        let this = self;
        unsafe {
            let mut result__: DeploymentStatus = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
...
impl ::std::convert::From<i32> for DeploymentStatus {
...
#[doc(hidden)]
pub struct IDeploymentManagerStatics(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IDeploymentResultFactory(::windows::runtime::IInspectable);
